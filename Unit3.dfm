object TMSForm3: TTMSForm3
  ...
  object AdvToolBarPager1: TAdvToolBarPager
    ...
    object AdvShapeButton1: TAdvShapeButton
      ...
      Appearance.ColorHotMirror = 1740058
      Appearance.ColorHotMirrorTo = 1740058
  ...
  object AdvToolBarOfficeStyler1: TAdvToolBarOfficeStyler
    ...
    GlowButtonAppearance.BorderColorChecked = 16246477
    GlowButtonAppearance.Color = clWhite
    GlowButtonAppearance.ColorTo = clWhite
    GlowButtonAppearance.ColorChecked = 16246477
    GlowButtonAppearance.ColorCheckedTo = 16246477
    ...
    GlowButtonAppearance.ColorDownTo = 15187578
    GlowButtonAppearance.ColorHot = 16246477
    GlowButtonAppearance.ColorHotTo = 16246477
    GlowButtonAppearance.ColorMirror = clWhite
    GlowButtonAppearance.ColorMirrorTo = clWhite
    GlowButtonAppearance.ColorMirrorHot = 16246477
    GlowButtonAppearance.ColorMirrorHotTo = 16246477
    GlowButtonAppearance.ColorMirrorDown = 15187578
    GlowButtonAppearance.ColorMirrorDownTo = 15187578
    GlowButtonAppearance.ColorMirrorChecked = 16246477
    GlowButtonAppearance.ColorMirrorCheckedTo = 16246477
  ...
  object AdvPreviewMenuOfficeStyler1: TAdvPreviewMenuOfficeStyler
    FrameAppearance.BorderColor = 12895944
    ...
    MenuItemAppearance.BorderColorHot = 15917525
    MenuItemAppearance.BorderColorDown = 14925219
    MenuItemAppearance.BorderColorChecked = 14925219
    MenuItemAppearance.BorderColorDisabled = clNone
    MenuItemAppearance.Color = clNone
    MenuItemAppearance.ColorTo = clNone
    MenuItemAppearance.ColorChecked = 15917525
    MenuItemAppearance.ColorCheckedTo = 15917525
    MenuItemAppearance.ColorDisabled = clNone
    MenuItemAppearance.ColorDisabledTo = clNone
    MenuItemAppearance.ColorDown = 14925219
    MenuItemAppearance.ColorDownTo = 14925219
    MenuItemAppearance.ColorHot = 15917525
    MenuItemAppearance.ColorHotTo = 15917525
    MenuItemAppearance.ColorMirror = clNone
    MenuItemAppearance.ColorMirrorTo = clNone
    MenuItemAppearance.ColorMirrorHot = 15917525
    MenuItemAppearance.ColorMirrorHotTo = 15917525
    MenuItemAppearance.ColorMirrorDown = 14925219
    MenuItemAppearance.ColorMirrorDownTo = 14925219
    MenuItemAppearance.ColorMirrorChecked = 15917525
    MenuItemAppearance.ColorMirrorCheckedTo = 15917525
    ...
    MenuItemAppearance.TextColorDown = 4474440
    MenuItemAppearance.TextColorHot = 4474440
  ...
  object AdvOfficeStatusBarOfficeStyler1: TAdvOfficeStatusBarOfficeStyler
    ...
    PanelAppearanceLight.BorderColorHot = clLime
    PanelAppearanceLight.BorderColorDown = clLime
    PanelAppearanceLight.Color = clWhite
    PanelAppearanceLight.ColorTo = clWhite
    PanelAppearanceLight.ColorHot = clLime
    PanelAppearanceLight.ColorHotTo = clLime
    PanelAppearanceLight.ColorDown = clLime
    PanelAppearanceLight.ColorDownTo = clLime
    PanelAppearanceLight.ColorMirror = clNone
    PanelAppearanceLight.ColorMirrorTo = clNone
    PanelAppearanceLight.ColorMirrorHot = clLime
    PanelAppearanceLight.ColorMirrorHotTo = clLime
    PanelAppearanceLight.ColorMirrorDown = clLime
    PanelAppearanceLight.ColorMirrorDownTo = clLime
    ...
    PanelAppearanceDark.BorderColorHot = clLime
    PanelAppearanceDark.BorderColorDown = clWhite
    PanelAppearanceDark.Color = clWhite
    PanelAppearanceDark.ColorTo = clWhite
    PanelAppearanceDark.ColorHot = clLime
    PanelAppearanceDark.ColorHotTo = clLime
    PanelAppearanceDark.ColorDown = clWhite
    PanelAppearanceDark.ColorDownTo = clWhite
    PanelAppearanceDark.ColorMirror = clNone
    PanelAppearanceDark.ColorMirrorTo = clNone
    PanelAppearanceDark.ColorMirrorHot = clLime
    PanelAppearanceDark.ColorMirrorHotTo = clLime
    PanelAppearanceDark.ColorMirrorDown = clWhite
    PanelAppearanceDark.ColorMirrorDownTo = clWhite
